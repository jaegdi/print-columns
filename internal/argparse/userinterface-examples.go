...
/**
 * @brief Prints example usage scenarios for the command-line tool.
 *
 * Displays example commands and their corresponding outputs to illustrate various functionalities of the `pc` command-line tool.
 */
