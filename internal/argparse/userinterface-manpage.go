...
/**
 * @brief Prints the manual page for the command-line tool.
 *
 * Displays a comprehensive manual page containing information about the tool's name, synopsis, description, parameters, author, copyright, and license.
 */
func cmdManpage() {
	paramsTxt := `
NAME
